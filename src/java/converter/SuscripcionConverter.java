...
@FacesConverter(value = "suscripcionConverter")
public class SuscripcionConverter implements Converter {

    private SuscripcionFacade ejbFacade;
    ...
    private SuscripcionFacade getEjbFacade() {
        this.ejbFacade = CDI.current().select(SuscripcionFacade.class).get();
